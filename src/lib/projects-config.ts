...
export const featuredProjects: CustomProject[] = [
  {
    ...
    impact: 'Shipping user-facing mobile features with observability, testing, and release discipline.',
  ...
  },
  {
    ...
    description: 'Internal developer productivity and AI workflow tooling that turns fragile environment setup into repeatable CLI flows.',
    language: 'Automation',
    category: 'professional',
    sourceType: 'proprietary',
    priority: 2,
    ...
    period: 'June 2026 - Present',
    impact: 'Reduced environment-switching friction with Vercel and Psono-backed CLI commands for staging and production.',
  ...
  },
  {
    ...
    name: 'AURA Voice Assistant',
    description: 'Private AI voice workflow backend that connects Vapi tool calls to onboarding email and calendar actions with quick responses and background processing.',
    language: 'Node.js',
    category: 'professional',
    sourceType: 'proprietary',
    priority: 6,
    ...
    period: '2026',
    impact: 'Shows practical AI workflow integration beyond demos: voice-agent tool calls, webhook reliability, email, calendar scheduling, and secret-driven deployment.',
