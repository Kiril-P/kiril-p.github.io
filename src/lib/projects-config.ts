...
export const featuredProjects: CustomProject[] = [
  ...
  },
  {
    ...
    description: 'Private AI voice automation webhook that connects Vapi tool calls to onboarding email and calendar workflows with immediate responses and background processing.',
    language: 'Node.js',
    category: 'professional',
    sourceType: 'proprietary',
    priority: 6,
    ...
    period: '2026',
    impact: 'Shows practical AI automation beyond demos: voice-agent tool calls, webhook reliability, transactional email, calendar scheduling, and secret-driven deployment.',
