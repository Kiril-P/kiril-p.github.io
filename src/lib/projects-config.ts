...
export const featuredProjects: CustomProject[] = [
  ...
  },
  {
    ...
    impact: 'Led a 3-developer team to 600+ cleanings and Best Undergraduate Startup at IE Venture Lab 2025, across booking, matching, payments, maps, and mobile release execution.',
    status: 'Best Undergraduate Startup 2025',
    confidential: true,
    group: 'professional',
  ...
  },
  {
    ...
    role: 'Solo Developer',
    period: '2026',
    impact: 'Real-time Three.js/WebGL black-hole renderer with shader-driven gravitational lensing, bloom, particles, and adaptive quality; exports PNG stills.',
  ...
  },
  {
    ...
    role: 'Solo Developer',
    period: '2026',
    impact: 'Ranked #7 for Enjoyment and #11 overall out of 160 entries in Mini Jam 202; released on itch.io with browser play and desktop downloads.',
    status: 'Mini Jam 202',
    group: 'game-dev',
  ...
  },
  {
    ...
    role: 'Solo Developer',
    period: '2026',
    impact: 'A single-encounter card battler with drag-to-play cards, a magical targeting line, and animated spell feedback - shipped as a static, framework-free site.',
